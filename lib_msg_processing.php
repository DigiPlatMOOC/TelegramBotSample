...
function process_message($message) {
    ...
    if (isset($message['text'])) {
        ...
        if (strpos($text, "/start") === 0) {
            ...
            telegram_send_message($chat_id, "Hello " . $message['from']['first_name'] . "! Try starting a conversation with the /conversation command.", null);
        }
            ...
            telegram_send_message($chat_id, "What is your favorite color?", null);
        }
            ...
            telegram_send_message($chat_id, "I didn't understand, sorry", null);
    	}
    }
    else {
